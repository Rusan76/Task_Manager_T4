...
**Основные возможности:**
    ...
    File and folder manager - создание, удаление, информация об папках/ файлах.

    Windows Optimization - очистка кеша, отключение ненужных служб, удаление встроенных системных программ, отключение визуальных эффектов.
